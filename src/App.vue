<template>
  <div id="app">
    ...
    <!-- END SLIDER -->
    <router-view :Carrinho="carrinho" @Carrinho="carrinho = $event" :Qtde0="qtde0" @Qtde0="qtde0 = $event" :Qtde1="qtde1" @Qtde1="qtde1 = $event" :Qtde2="qtde2" @Qtde2="qtde2 = $event"/>
